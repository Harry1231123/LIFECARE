...
export const COURSES = [
  ...
  },
  {
    ...
    addon: {
      ...
      description: "ASIST (Applied Suicide Intervention Skills Training) is an internationally recognised, evidence-based two-day workshop that teaches participants to recognise when someone may be at risk of suicide and to provide skilled, immediate intervention. Used in over 30 countries, ASIST goes significantly beyond standard Mental Health First Aid - it provides a structured, step-by-step model for directly engaging with someone in suicidal crisis and keeping them safe.",
