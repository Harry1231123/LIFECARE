...
const POSTS = [
  {
    ...
    content: [
      ...
      { type: 'ul', items: [
        'Reduces burn depth — partial thickness burns can progress to full thickness without adequate cooling; early cooling arrests that progression',
        'Accelerates healing — cooled burns re-epithelialise faster because the local inflammatory cascade is moderated',
        'Minimises scarring — shallower burns leave less scarring; preventing depth progression directly reduces long-term cosmetic and functional impact',
      ...
      { type: 'ul', items: [
        ...
        'Cover with cling film loosely after cooling — never before; it traps heat',
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'p', text: "The Regulations apply to every employer in Great Britain, regardless of the size or type of business. There are no exemptions based on the number of employees, the nature of the work, or whether the business operates from a fixed location. A sole trader with one part-time employee is covered. A multinational with ten thousand staff is covered. The scale of your obligations differs — the obligation itself does not." },
      ...
      { type: 'callout', text: "L74 guidance is clear: if your lone first aider is absent — on holiday, off sick, or on a different shift — you must have arrangements in place to cover their absence. This often means training additional personnel." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'p', text: "Although not currently mandated by law, MHFA training is increasingly referenced by employment tribunals, personal injury claims, and HSE inspectors as evidence of whether an employer took reasonable steps to address known mental health risks. In sectors with high stress prevalence — healthcare, education, emergency services, hospitality — the absence of MHFA provision may be difficult to justify if a claim is brought." },
      ...
      { type: 'ul', items: [
        ...
        'Document everything — your assessments, your control measures, your training records',
      ]},
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'p', text: "I've attended incidents where bystanders started CPR on someone who was breathing but unconscious — a diabetic emergency, a seizure postictal phase, a stroke. Starting chest compressions on a person who is breathing can cause significant internal injury. The primary survey takes less than ten seconds. It cannot be skipped." },
  ...
  },
  {
    ...
    excerpt: "Every event organiser has a duty of care. But the required level of cover depends on your specific event — here's how to assess it.",
    date: '5 Mar 2025',
    readTime: '5 min',
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'p', text: "A group EFAW course for up to twelve employees costs from £850. An FAW certificate costs from £1,850. A fully stocked first aid kit costs under £50. The total cost of proper compliance for most small businesses is in the hundreds of pounds. The cost of non-compliance — FFI charges, Improvement Notice, potential prosecution, insurance complications, and reputational damage — begins in the thousands and has no upper limit." },
